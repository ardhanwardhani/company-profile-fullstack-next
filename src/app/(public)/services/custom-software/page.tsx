...
import { Code2, Layout, Smartphone, Cloud, Database, Lock, Zap, ArrowRight, Mail, CheckCircle, Terminal, Box, Workflow, Cpu } from 'lucide-react';
...
async function getSettings(): Promise<Settings> {
  try {
    const res = await fetch(`${String(process.env.NEXT_PUBLIC_APP_URL)}/api/public/settings`, { cache: 'no-store' });
...
const features = [
  {
    ...
    description: 'Build from scratch web applications tailored to your specific business needs and workflows.',
  },
  {
    icon: Smartphone,
    title: 'Mobile Apps',
  ...
  },
  {
    ...
    description: 'Robust server-side architecture with secure APIs, databases, and cloud infrastructure.',
  },
  {
    icon: Cloud,
    title: 'Cloud Solutions',
    description: 'Scalable cloud-based solutions using AWS, Azure, or Google Cloud platforms.',
  },
  {
    icon: Lock,
    title: 'Security & Compliance',
    description: 'Enterprise-grade security measures including encryption, authentication, and compliance with industry standards.',
  },
  {
    icon: Workflow,
    title: 'API Integration',
    description: 'Seamless integration with third-party services, payment gateways, and existing systems.',
  },
  {
    icon: Box,
    title: 'E-commerce Solutions',
    description: 'Custom online stores with payment processing, inventory management, and order tracking.',
  },
  {
    icon: Cpu,
    title: 'SaaS Development',
    description: 'Software-as-a-service products with subscription management and multi-tenant architecture.',
  },
];
...
const developmentProcess = [
  { step: '01', title: 'Discovery', description: 'We analyze your requirements and business goals to create a detailed specification.' },
  { step: '02', title: 'Design', description: 'Our team creates intuitive UI/UX designs and technical architecture.' },
  { step: '03', title: 'Development', description: 'We build your solution using agile methodology with regular updates.' },
  { step: '04', title: 'Testing', description: 'Rigorous testing ensures quality, security, and performance.' },
  { step: '05', title: 'Deployment', description: 'We launch your product and provide ongoing support.' },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-white/90 max-w-2xl">
                Tailored software solutions built from scratch to address your unique business challenges and requirements.
              </p>
                ...
                <div className="aspect-square bg-gray-100 rounded-2xl p-8 flex items-center justify-center">
                  <div className="w-full h-full bg-dark-900 rounded-xl p-6 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-white font-semibold text-xl">Custom Solutions</div>
                      <div className="text-gray-400 text-sm mt-2">Built for your needs</div>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-8">
                Let's discuss your project and create software that drives real business value.
              </p>
