  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-900">
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="aspect-square bg-gray-100 dark:bg-dark-800 rounded-2xl p-8 flex items-center justify-center">
                  <div className="w-full h-full bg-white dark:bg-dark-900 rounded-xl shadow-lg p-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-dark-800 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-gray-900 dark:text-gray-100">Job Listings</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400">Manage openings easily</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-dark-800 rounded-lg">
                        <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center">
                        ...
                        <div>
                          <div className="font-medium text-gray-900 dark:text-gray-100">Blog Management</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400">Publish content regularly</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-dark-800 rounded-lg">
                        <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center">
                        ...
                        <div>
                          <div className="font-medium text-gray-900 dark:text-gray-100">Team Profiles</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400">Showcase your talent</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-dark-800 rounded-lg">
                        <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-400">Track performance</div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        {/* Features Section */}
        <section id="features" className="py-20 bg-gray-50 dark:bg-dark-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-dark-900 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Why Choose Our Package?</h2>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="bg-primary-50 dark:bg-dark-800 rounded-2xl p-8"
              >
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Ready to Get Started?</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-8">
        ...
        <section className="py-20 bg-gray-50 dark:bg-dark-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Other Services</h2>
            </motion.div>
