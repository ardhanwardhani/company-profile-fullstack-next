    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-950">
      ...
      <main>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row gap-8">
            <aside className="md:w-64">
              <div className="bg-white dark:bg-dark-900 rounded-lg shadow-sm p-6 sticky top-24">
                <h3 className="font-semibold mb-4 dark:text-gray-100">Filter Jobs</h3>

                <div className="mb-4">
                  <label className="block text-sm text-gray-600 dark:text-gray-400 mb-2">Department</label>
                  <select className="w-full px-3 py-2 border border-gray-300 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-100 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-gray-600 dark:text-gray-400 mb-6">{jobs.length} open positions</p>

              <div className="space-y-4">
                {jobs.map((job: any) => (
                  <Link href={`/careers/${job.slug}`} key={job.id} className="block bg-white dark:bg-dark-900 rounded-lg shadow-sm hover:shadow-lg transition-shadow p-6">
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="text-xl font-semibold mb-2 dark:text-gray-100">{job.title}</h3>
        ...
        <section className="bg-white dark:bg-dark-900 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-6 dark:text-gray-100">Why Work With Us?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-2 dark:text-gray-100">Remote-Friendly</h3>
                <p className="text-gray-600 dark:text-gray-400">Work from anywhere. We trust you to manage your time.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 dark:text-gray-100">Growth Opportunities</h3>
                <p className="text-gray-600 dark:text-gray-400">Learning budget and clear career progression paths.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 dark:text-gray-100">Great Benefits</h3>
                <p className="text-gray-600 dark:text-gray-400">Health insurance, PTO, and competitive compensation.</p>
              </div>
            </div>
          </div>
        </section>
