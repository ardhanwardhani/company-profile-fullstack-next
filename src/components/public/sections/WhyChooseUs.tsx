...
export function WhyChooseUs() {
  return (
    <SectionWrapper id="why-choose-us" className="bg-gray-50 dark:bg-dark-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl">We stand out from the competition with our commitment to excellence and client success.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-dark-900 border-l-4 border-l-primary-700 p-8 hover:shadow-lg transition-shadow"
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-primary-50 dark:bg-primary-900/20 flex items-center justify-center flex-shrink-0">
